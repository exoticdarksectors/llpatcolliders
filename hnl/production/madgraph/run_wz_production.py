...
Adapted from reference project's run_hnl_scan.py:
  - Uses external MG5 (set MG5_DIR env var, default /Users/fredi/sandbox-offline/MG5_aMC_v3_6_6)
...
# MG5 executable — use external installation (set MG5_DIR env var to override)
MG5_EXE = Path(os.environ.get(
    "MG5_DIR", "/Users/fredi/sandbox-offline/MG5_aMC_v3_6_6")) / "bin" / "mg5_aMC"
