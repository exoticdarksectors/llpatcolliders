...
int main() {
    ...
    pythia.readString("6000113:all = S S 1 0 0 40.");
    pythia.readString("6000113:mWidth = 3.9466e-16");
    pythia.readString("6000113:tau0 = 500.");
    pythia.readString("25:addChannel = 1 1.0 100 6000113 -6000113");
    pythia.readString("6000113:mayDecay = 1");
    pythia.readString("6000113:isResonance = on");
    pythia.readString("6000113:onMode = 0");
    pythia.readString("6000113:addChannel = 1 1.0 100 5 -5");
    //pythia.readString("51:addChannel = 1 0.0001 100 11 -11");
    ...
    TFile* outFile = new TFile("SM_SM_2S_bb_500mm_40GeV_jet.root", "RECREATE");
