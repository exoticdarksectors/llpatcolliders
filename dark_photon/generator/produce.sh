...
#
# Event-targeted production driver for dark-photon samples.
#
...
#
# Notes:
# - For h -> A'A' runs with 25:onIfAny = 6000115, each generated event should
#   carry two LLPs (up to generator failures).
# - BR(h->A'A') normalization is done in analysis; generation stays at BR=1.
#
# Examples:
#   bash produce.sh heavy_dp_m15.cmnd 10000 dp_heavy_m15
#   bash produce.sh heavy_dp_m15.cmnd 10000 dp_heavy_m15 4
#   bash produce.sh heavy_dp_m15.cmnd 10000 dp_heavy_m15 4 1500
